...
(function (global) {
  ...
  const MESSAGES = {
    de: {
      ...
      'admin.deadline_hint':       'Zeitfenster ab jetzt. Bei Ablauf wird das Event pausiert.',
      'admin.deadline_h_ph':       'h',
      'admin.deadline_m_ph':       'min',
    ...
    en: {
      ...
      'admin.deadline':            'Deadline',
      'admin.deadline_hint':       'Time window from now. The event auto-pauses when it expires.',
      'admin.deadline_h_ph':       'h',
      'admin.deadline_m_ph':       'min',
